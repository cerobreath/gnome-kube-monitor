...
export const KubeIndicator = GObject.registerClass({
    ...
    _makeNodeItem(node) {
        ...
        // Untranslated on purpose, like the Ready/NotReady vocabulary: these
        // mirror the CPU% / MEMORY% columns of kubectl top in every locale.
        ...
        item.connect('activate', () => {
            ...
            // The extension owns the notifier, so it confirms the copy from the
            // extension's own source rather than the generic "System" one.
