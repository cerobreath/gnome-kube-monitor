...
import {NodeLevel, compareNodes, nodeQualifier} from './model.js';
...
export const KubeIndicator = GObject.registerClass({
    ...
    _renderPods(pods) {
        ...
        this._podsBox.add_child(new St.Icon({
            icon_name: 'view-grid-symbolic', icon_size: 14,
            style_class: 'kube-pods-icon', y_align: Clutter.ActorAlign.CENTER,
        }));
