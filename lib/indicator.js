...
export const KubeIndicator = GObject.registerClass({
    ...
    _setContextsExpanded(expanded) {
        ...
        this._syncContextName();
    }

    // The button carries no label actor, so without this it is announced as a
    // bare push button, and it goes stale whenever the context changes.
    _syncContextName() {
        const expanded = this._contextsExpanded;
